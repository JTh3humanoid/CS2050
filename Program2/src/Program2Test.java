...
class Program2Test {
    ...
    @Test
    public void testZeroDividePositive() throws Exception {
    ...
    @Test
    public void testPositiveDividePositive() throws Exception {
        assertEquals(2.5, Program2.divide(5, 2), DELTA);
        assertEquals(0.4, Program2.divide(2, 5), DELTA);
    }

    @Test
    public void testZeroDivideNegative() throws Exception {
        assertEquals(0, Program2.divide(0, -5 ), DELTA);
    }
    ...
    @Test
    public void testNegativeDivideNegative() throws Exception {
        assertEquals(2.5, Program2.divide(-5, -2), DELTA);
        assertEquals(0.4, Program2.divide(-2, -5), DELTA);
    }

    @Test
    public void testPositiveDivideNegative() throws Exception {
        assertEquals(-2.5, Program2.divide(5, -2), DELTA);
    }

    @Test
    public void testNegativeDividePositive() throws Exception {
        assertEquals(-2.5, Program2.divide(-5, 2), DELTA);
    }
